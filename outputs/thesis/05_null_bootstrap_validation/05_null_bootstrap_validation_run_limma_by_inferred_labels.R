...
usage <- function() {
  cat(
    paste(
      "Usage:",
      "Rscript outputs/thesis/05_null_bootstrap_validation/05_null_bootstrap_validation_run_limma_by_inferred_labels.R \\",
      "  --counts-path <path> \\",
      "  --labels-path <path> \\",
      "  [--output-dir <path>] \\",
      "  [--id-prefix-length 15] \\",
...
parse_args <- function(argv) {
  defaults <- list(
    "output-dir" = "outputs/thesis/05_null_bootstrap_validation/generated/de_limma_counts_raw_500k_spearman_r_linear_resid",
    "id-prefix-length" = "15",
    "contrast-case" = "foxa2_abnormal_zero",
    "contrast-control" = "foxa2_normal_pos",
    "min-count" = "5",
