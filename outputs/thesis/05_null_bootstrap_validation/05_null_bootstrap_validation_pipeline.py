...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument(
        "--out-dir",
        default="outputs/thesis/05_null_bootstrap_validation/generated/null_shuffle_bootstrap_foxa2_counts_raw_500k",
...
def main() -> None:
    ...
    while project_root != project_root.parent and not (project_root / "outputs" / "thesis").exists():
