...
RESULT_NAME="03_differential_expression"
...
# outputs/thesis/03_differential_expression/03_differential_expression_deseq2_binary_all_genes.csv
...
# outputs/thesis/03_differential_expression/
Rscript scripts/03_differential_expression/run_de_followups_stepwise.R
