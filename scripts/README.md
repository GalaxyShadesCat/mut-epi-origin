...
- `02_hepatocyte_clinical_associations/`: hepatocyte state and clinical association analyses.
- `03_differential_expression/`: DE and follow-up expression analyses.
...
- `scripts/02_hepatocyte_clinical_associations/reproduce_result.sh`
- `scripts/03_differential_expression/reproduce_result.sh`
