...
RESULT_NAME="02_hepatocyte_clinical_associations"

# Reproduce:
# outputs/thesis/02_hepatocyte_clinical_associations/02_hepatocyte_state_benchmark_results.csv
...
CMD_FILE="outputs/thesis/02_hepatocyte_clinical_associations/02_hepatocyte_state_benchmark_run_command.txt"
if [[ ! -f "${CMD_FILE}" ]]; then
